...
-- SELECT * es útil para explorar una tabla nueva y ver su estructura completa,
-- pero en producción es mala práctica: trae columnas innecesarias y es más lento.
